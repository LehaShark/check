...
if __name__ == '__main__':
    ...
    image_transforms = {train_key: A.Compose([
                        ...
                        test_key: A.Compose([A.Resize(height=256, width=256),
                                             A.CenterCrop(224, 224),
                                             *normalize
                                             ])
    ...
    dataloaders_dict = {train_key: DataLoader(datasets_dict[train_key],
                        ...
                        test_key: DataLoader(datasets_dict[test_key],
                                             batch_size=trainer_config.batch_size)}
    ...
    model = trainer.load_model(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "logs\\weight_decay\\74.pth"))
    trainer.test()
